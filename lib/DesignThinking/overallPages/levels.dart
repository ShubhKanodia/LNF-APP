      ...
      children: [
        ...
        Positioned(
          ...
          child: CircularOrangeButton(
              enabled: true,
              number: true,
              light: currentProgress.taskUnlocked == 0,
              text: "1",
              onTap: () {
        ...
        Positioned(
          ...
          left: width * 0.25,
          child: CircularOrangeButton(
              enabled: currentProgress.taskUnlocked >= 7,
              number: true,
              light: currentProgress.taskUnlocked == 7,
              text: "2",
              onTap: () {
        ...
        Positioned(
          ...
          left: width * 0.03,
          child: CircularOrangeButton(
              enabled: currentProgress.taskUnlocked >= 15,
              number: false,
              text: "Finish",
              onTap: () {
                Navigator.push(
    ...
    return Scaffold(
      ...
      children: [
        ...
        Positioned(
          ...
          left: width * 0.04,
          child: SquareBlueButton(
              insideImageUrl: "assets/levelIndicator.svg",
              onTap: () {
        ...
        Positioned(
          ...
          right: width * 0.2,
          child: CircularOrangeButton(
              enabled: currentProgress.taskUnlocked >= 6,
              number: false,
              light: currentProgress.taskUnlocked == 6,
              text: "Quiz",
              onTap: () {
      ...
      children: [
        ...
        Positioned(
          ...
          child: CircularOrangeButton(
              enabled: true,
              number: false,
              light: currentProgress.taskUnlocked == 8,
              text: "Start",
              onTap: () {
                Navigator.push(
                  context,
        ...
        Positioned(
          ...
          right: width * 0.2,
          child: CircularOrangeButton(
              enabled: currentProgress.taskUnlocked >= 14,
              number: false,
              light: currentProgress.taskUnlocked == 14,
              text: "Quiz",
              onTap: () {
                currentQuizProgress.reset();
                Navigator.push(
